...
public class BreweryClient {
    ...
    public BeerDto getBeerById(UUID uuid) {
        return restTemplate.getForObject(this.apihost + this.BEER_PATH_V1 + uuid.toString(), BeerDto.class);
    }
    ...
    public void updateBeer(UUID uuid, BeerDto beerDto) {
        restTemplate.put(this.apihost + this.BEER_PATH_V1 + uuid.toString(), beerDto);
    }
